# Functional Python [![](https://github.com/elissayz/functional-python/workflows/tests/badge.svg)](https://github.com/elissayz/functional-python/actions?query=workflow%3Atests)
